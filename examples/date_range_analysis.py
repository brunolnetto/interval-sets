...
def main():
    ...
    print(
        f"  Data available: {covered_time:.0f} seconds ({covered_time/total_time*100:.1f}%)"
    )
    print(
        f"  Data missing: {missing_time:.0f} seconds ({missing_time/total_time*100:.1f}%)"
    )
    ...
    print(f"\nUpdated Coverage:")
    print(
        f"  Data available: {new_covered:.0f} seconds ({new_covered/total_time*100:.1f}%)"
    )
    print(
        f"  Data missing: {new_missing:.0f} seconds ({new_missing/total_time*100:.1f}%)"
    )
    print(
        f"  Improvement: +{(new_covered - covered_time):.0f} seconds "
