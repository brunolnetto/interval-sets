...
def run_demo():
    ...
    print(f"Footprint Dimensions: {footprint.intervals[0].length()}m x {footprint.intervals[1].length()}m")
    ...
    print(f"Area of the house boundary: {house_boundary.volume()} (should be 0 for a 2D shell)")
    print(f"The boundary consists of {len(house_boundary.boxes)} boundary line segments/points.")
